...
namespace QuizMVC.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IUsersRolesAndScoresRepository usersRolesAndScoresRepo,
            Context context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var role = _usersRolesAndScoresRepo.GetRole("User");
                ...
                var score = new Score { UserLogin = Input.Email, BestResult = 0, CurrentResult = 0 };
